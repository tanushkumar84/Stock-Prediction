...
def fetch_stock_history(stock_ticker, period, interval):
    try:
        ...
        print(f"An error occurred while fetching stock history: {e}")
        return pd.DataFrame()
...
def generate_stock_prediction(stock_ticker):
    try:
        ...
        return train_df, test_df, forecast, predictions, mae, mse, rmse

    except Exception as e:
        print(f"An error occurred while generating stock prediction: {e}")
